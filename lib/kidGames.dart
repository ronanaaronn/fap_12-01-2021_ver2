import 'package:ausome_fap/KidGames/colorTap.dart';
import 'package:ausome_fap/KidGames/matchTheShape.dart';
...
void main() =>
    runApp(KidGames());
class KidGames extends StatelessWidget {
  @override
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: (){
                            Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => ColorTap())
                            );
                          },
                        ),
                      ),
